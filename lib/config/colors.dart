...
class AppColors {
  ...
  static Color gradientColor1 = Color(0xFFCADDED);
  static Color gradientColor2 = Color(0xFFCADCED);
  static Color gradientColor3 = Color(0xFFCADCED);
  static Color gradientColor4 = Color(0xFFCFDCED);
